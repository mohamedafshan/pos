...
<body class="authentication-bg authentication-bg-pattern">
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="error-ghost text-center">
                                <svg class="ghost" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    height="132.743px" viewBox="0 0 127.433 132.743"
                                    ...
                                    <circle fill="#FCEFED" stroke="#FEEBE6" stroke-miterlimit="10" cx="18.614"
                                        cy="99.426" r="3.292" />
                                    <circle fill="#FCEFED" stroke="#FEEBE6" stroke-miterlimit="10" cx="95.364"
                                        cy="28.676" r="3.291" />
                                    <circle fill="#FCEFED" stroke="#FEEBE6" stroke-miterlimit="10" cx="24.739"
                                        cy="93.551" r="2.667" />
                                    <circle fill="#FCEFED" stroke="#FEEBE6" stroke-miterlimit="10" cx="101.489"
                                        cy="33.051" r="2.666" />
                                    <circle fill="#FCEFED" stroke="#FEEBE6" stroke-miterlimit="10" cx="18.738"
                                        cy="87.717" r="2.833" />
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted mb-0">It's looking like you may have taken a wrong turn. Don't
                                    worry...
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-white-50">Return to <a href="{{ route('dashboard') }}"
                                    class="text-white ms-1"><b>Home</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
    ...
    <footer class="footer footer-alt">
        ...
        </script> &copy; Rubysoft  <a href="" class="text-white-50">Coderthemes</a>
    </footer>

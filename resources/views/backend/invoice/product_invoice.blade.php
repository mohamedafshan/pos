                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="float-end">
                                        ...
                                        <p><b>Discount (21%):</b> <span class="float-end"> &nbsp;&nbsp;&nbsp;
                                                {{ Cart::tax() }}</span>
                                        </p>
                                        <h3>{{ Cart::total() }}</h3>
                                    </div>
                            ...
                            <div class="mt-4 mb-1">
                                <div class="text-end d-print-none">
                                    ...
                                    <a href="" class="btn btn-primary waves-effect waves-light"
                                        data-bs-toggle="modal" data-bs-target="#signup-modal">Create Invoice</a>
                                </div>
                            </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="px-3" action="{{ url('/final-invoice') }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="example-select" name="payment_status" >
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="Pay Now"
                                                        name="pay">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="Due Amount"
                                                        name="due">
                                                </div>

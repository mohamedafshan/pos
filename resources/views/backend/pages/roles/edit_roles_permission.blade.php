                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Roles In Permission</a></li>
                            </ol>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form method="POST" action="{{ route('role.permission.update',$role->id) }}" id="myForm">
                                    @csrf
                                    <div class="row">
                                                    ...
                                                    @foreach ($permissions as $permission)
                                                        <div class="form-check mb-2 form-check-primary">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="{{ $permission->id }}"
                                                                id="customckeck{{ $permission->id }}" name="permission[]" {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }}>
                                                            <label class="form-check-label"

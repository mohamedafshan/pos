                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select" id="example-select" name="catergory_id" >
                                                    ...
                                                    @foreach ($catergory as $cater)
                                                        <option value="{{ $cater->id }}">{{ $cater->catergory_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    class="form-control" name="product_garage">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    class="form-control" name="product_store">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date"
                                                    class="form-control" name="buying_date">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    class="form-control" name="buying_price">
                                            </div>
                                        </div>

                                ...
                                @foreach ($allData as $key=> $item)                                
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- The reason is we get the group of data for date not a id  --}}
                                            
                                            <a href="{{ route('view.employee.attendence',$item->date) }}" class="btn btn-danger rounded-pill waves-effect waves-light">View</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
